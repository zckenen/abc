define(['global'], function(Global){
	...
	function liquidFillGaugeDefaultSettings(){
	    return {
	        ...
	        waveColor: "#3385ff", // The color of the fill wave.
	...
	function loadLiquidFillGauge(elementId, value, config) {
	    ...
	    if(config.waveAnimate && !timer) {
	    	timer = setInterval(function(){
	    		var i = 0, len = fun.length;
	    		for( ; i < len; i++ ) {
	    			fun[ i ].call(this, config.waveAnimateTime);
	    		}
	    	}, 4000);
	    } else if ( config.waveAnimate && timer ) {

	    	fun.push( animateWave );
	    }
